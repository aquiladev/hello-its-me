...
contract LendingPoolConfigurator is VersionedInitializable, ILendingPoolConfigurator {
  ...
  function enableRewards() external onlyPoolAdmin {
    IStakingConfigurator configurator = IStakingConfigurator(
      addressesProvider.getStakingConfigurator()
    );
    IMultiFeeDistribution(configurator.getMultiFeeDistribution()).setPause(false);
  }

  function disableRewards() external onlyPoolAdmin {
    IStakingConfigurator configurator = IStakingConfigurator(
      addressesProvider.getStakingConfigurator()
    );
    IMultiFeeDistribution(configurator.getMultiFeeDistribution()).setPause(true);
  }
